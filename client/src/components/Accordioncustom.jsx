...
const Accordion = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-gradient-to-r from-teal-300 via-teal-400 to-teal-500 pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
